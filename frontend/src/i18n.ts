...
export const copy = {
  es: {
    ...
    instagramUsername: 'Usuario de Instagram (opcional)',
    instagramAction: 'Instagram',
    instagramPlaceholder: 'usuario_sin_tacc',
